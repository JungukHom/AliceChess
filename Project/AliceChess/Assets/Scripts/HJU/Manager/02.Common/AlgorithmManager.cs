    ...
    public class AlgorithmManager : Manager
    {
        ...
        private List<Vector2> King(int xPos, int zPos)
        {
            ...
            try
            {
                ...
                {
                    ChessPieceManager manager = board[i, zPos + 1];
            ...
            try
            {
                for (int i = xPos - 1; i <= xPos + 1; i++)
                {
                    ChessPieceManager manager = board[i, zPos];
        ...
        private List<Vector2> Queen(int xPos, int zPos)
        {
            ...
            if (zPos != 7)
            {
                try
                {
                    ...
                    {
                        ChessPieceManager manager = board[xPos, i];
            ...
            if (xPos != 7)
            {
                ...
                while (true)
                {
                    try
                    {
                        int x = --lu_x;
                        int z = ++lu_z;
                        ChessPieceManager manager = board[x, z];
        ...
        private List<Vector2> BlackPawn(ChessPieceManager[,] board, int xPos, int zPos)
        {
            List<Vector2> result = new List<Vector2>();
            try
            {
        ...
        private List<Vector2> WhitePawn(ChessPieceManager[,] board, int xPos, int zPos)
        {
            List<Vector2> result = new List<Vector2>();
            try
            {
